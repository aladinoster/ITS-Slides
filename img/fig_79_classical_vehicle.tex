...
\begin{tikzpicture}%[show background rectangle, background rectangle/.style={fill=black}]
	...
	\node[rectangle,draw=cyan, line width=1mm, inner sep=0pt] (v2i) at (-5+0.5*\roadlength,2*\lanewidth - 0.5*\lanewidth) {\includegraphics[width=\vehiclelength cm]{img/src/simple_vehicle.pdf}};
	...
	%%column 2
	\node[legend] (legend11) at (0.11*\roadlength, -3) {\large Regular vehicle};
	\node[legend, opacity=0.0] at (0.11*\roadlength, -5) {\large Exchanged information -- V2V};
